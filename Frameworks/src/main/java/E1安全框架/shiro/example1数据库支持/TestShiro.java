package E1安全框架.shiro.example1数据库支持;

import E1安全框架.shiro.example0入门.User;
...
/**
 * Created By ChengZhen on 2020/1/14.
 * Author: Ash
 * Date: 2020/1/14
 * Time: 11:21
...
public class TestShiro {
    ...
    private static Subject getSubject(User user) {
        //加载配置文件，并获取工厂
        Factory<SecurityManager> factory = new IniSecurityManagerFactory("/Users/chengzhen/workAndLearning_cz/idea-workspace/learning-java/框架/src/main/java/E1安全框架/shiro/example1数据库支持/shiro.ini");
        //获取安全管理者实例

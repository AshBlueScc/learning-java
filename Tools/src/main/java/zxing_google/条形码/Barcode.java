...
public class Barcode {
    ...
    public static void main(String[] args) {
        File file = new File("/Users/chengzhen/workAndLearning_cz/idea-workspace/learning-java/Tools/src/main/java/zxing_google/条形码/iop.bmp");
//        generateCode(file, "123456", 400, 50);
